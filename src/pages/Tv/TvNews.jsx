...
function TvNews() {
  ...
  const getMovieById = async () => {
    try {
      const responseData = await tvShows.getMoviesByName(`${id}?language=${language}-US`, 'tv');
  ...
  return (
    <div style={{ background: `url(https://media.themoviedb.org/t/p/w440_and_h660_face/${movie?.poster_path})` }} className='container_movies'>
